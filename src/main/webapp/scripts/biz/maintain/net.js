...
$(function(){
	...
	var subCodeIndex = url.indexOf("subCode");
	if(subCodeIndex > -1){
		var subCodeStr = url.substring(subCodeIndex, url.length);
		subCode = subCodeStr.split("=")[1];
	}
	if(subCode=="privatenetwork"){
		$("ul a[href='#private_network']").click();
	} else{
		Route.init();
	}
