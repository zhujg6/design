	  		...
	  		//查询历史数据,每次返回一天数据
                ...
                if(data&&data.length > 0){
                	...
                	for(i=0;i<data.length;i++){
                        ...
                        monitormg.net_r.push([ti, Math.round(info.netIn*10)/10]);// /1024
                        monitormg.net_w.push([ti, Math.round(info.netOut*10)/10]);// /1024
                        monitormg.disk_r.push([ti, Math.round(info.diskIn*10)/10]);// /1024
                        monitormg.disk_w.push([ti, Math.round(info.diskOut*10)/10]);// /1024
                    }
