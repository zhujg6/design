...
//			console.log(data);
	...
	refreshData : function(){
		...
		desktopCloud.service.queryUserInfo(params2,function onSuccess(data){
...
//			          }
	...
	onInstanceSelected : function(selectInstance){
		...
		if(rightClicked) {
			...
			//desktopCloud.showDetails(desktopCloud.selectedInstanceId);
	    } else {
...
//					com.skyform.service.desktopCloudService.queryAreaInfo({},function(result){
//						console.log(result);
//						$("#areaSelect").empty();
//						$.each(result,function(key,value){
//							desktopCloud.areaInfo[value.ereaId]=value.ereaFlag;
//							var option=$("<option></option>");
//							$(option).attr("value",value.ereaId);
//							$(option).html(value.desc);
//							$("#areaSelect").append(option);
//						});
//					},function(){});
